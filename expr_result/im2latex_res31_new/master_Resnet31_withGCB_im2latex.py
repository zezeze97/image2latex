...
label_convertor = dict(
    ...
    dict_file=
    '/home/zhangzr/Master_image2latex/data/im2latex_data/master_data/new_keys.txt',
    max_seq_len=150,
    start_end_same=False,
    with_unknown=True)
PAD = 543
model = dict(
    ...
    decoder=dict(
        ...
        decoder=dict(
            ...
            dropout=0.0),
        d_model=512),
    loss=dict(type='MASTERTFLoss', ignore_index=543, reduction='mean'),
    label_convertor=dict(
        type='MasterConvertor',
        dict_file=
        '/home/zhangzr/Master_image2latex/data/im2latex_data/master_data/new_keys.txt',
...
train1 = dict(
    type='OCRDataset',
    img_prefix=
    '/home/zhangzr/Master_image2latex/data/im2latex_data/formula_images_processed/',
    ann_file=
    '/home/zhangzr/Master_image2latex/data/im2latex_data/master_data/train.txt',
    loader=dict(
        type='HardDiskLoader',
        repeat=1,
        parser=dict(
...
test_ann_files = dict(
    ...
    '/home/zhangzr/Master_image2latex/data/im2latex_data/master_data/val.txt')
testset = [
    dict(
        type='OCRDataset',
        img_prefix=
...
work_dir = './expr_result/im2latex_res31_new/'
gpu_ids = range(0, 1)
