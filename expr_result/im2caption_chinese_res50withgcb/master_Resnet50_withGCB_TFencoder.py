...
label_convertor = dict(
    ...
    dict_file='../im2caption_data/chinese_caption/chinese_vocab.txt',
    max_seq_len=40,
    start_end_same=False,
    with_unknown=True)
PAD = 2533
...
train1 = dict(
    type='OCRDataset',
    img_prefix=
    '../im2caption_data/chinese_caption/ai_challenger_caption_train_20170902/caption_train_images_20170902/',
    ann_file='../im2caption_data/chinese_caption/train.txt',
    loader=dict(
        type='HardDiskLoader',
        repeat=1,
        parser=dict(
...
test_ann_files = dict(
    table_Rec_val_debug_0='../im2caption_data/chinese_caption/mini_val.txt')
testset = [
    dict(
        type='OCRDataset',
        img_prefix=
        '../im2caption_data/chinese_caption/ai_challenger_caption_validation_20170910/caption_validation_images_20170910/',
        ann_file='../im2caption_data/chinese_caption/mini_val.txt',
        loader=dict(
            type='HardDiskLoader',
            repeat=1,
            parser=dict(
...
work_dir = 'expr_result/im2caption_chinese_res50withgcb/'
gpu_ids = range(0, 2)
